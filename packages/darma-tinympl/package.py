...
class DarmaTinympl(CMakePackage):
  """A metaprogramming library providing useful functions
     for DARMA programs
  """

  homepage = "https://github.com/DARMA-tasking"
  url      = "https://github.com/DARMA-tasking/tinympl"


  version('1.0',
        git='https://github.com/DARMA-tasking/tinympl',
        branch='devel')
